                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between gap-2 mb-1">
                        <h3 className={`font-semibold ${isDark ? 'text-white' : 'text-slate-900'} text-left`}>
                          {notification.title}
                        </h3>
                        {!notification.read && (
                      ...
                      <p className={`text-sm ${isDark ? 'text-slate-400' : 'text-slate-600'} text-left mb-3`}>
                        {notification.message}
                      </p>
                      
                      {/* Accept/Decline buttons only for invite type */}
                      {notification.type === 'invite' && (
                        <div className="flex gap-2">
                          <button
                            ...
                            className="flex-1 bg-green-500 text-white py-2 px-4 rounded-lg font-semibold text-sm active:scale-[0.98] transition-transform"
                          >
                            Accept
                          </button>
                          <button
                            ...
                            className={`flex-1 ${isDark ? 'bg-slate-700 text-white' : 'bg-slate-200 text-slate-700'} py-2 px-4 rounded-lg font-semibold text-sm active:scale-[0.98] transition-transform`}
                          >
                            Decline
                          </button>
                        </div>

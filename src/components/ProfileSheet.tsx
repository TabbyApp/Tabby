        ...
        <div className={`mx-auto max-w-[430px] ${isDark ? 'bg-slate-800' : 'bg-white'} rounded-t-[20px] overflow-hidden`}>
          ...
          <div className={`px-4 py-5 border-b ${isDark ? 'border-slate-700' : 'border-gray-200'}`}>
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className={`text-[20px] font-semibold ${isDark ? 'text-white' : 'text-black'}`}>John Doe</div>
                <div className={`text-[15px] ${isDark ? 'text-slate-400' : 'text-gray-500'}`}>john@example.com</div>
              </div>
            </div>
          </div>

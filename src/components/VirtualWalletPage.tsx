...
export function VirtualWalletPage({ onNavigate, theme }: VirtualWalletPageProps) {
  ...
  const [cards, setCards] = useState([
    { id: 1, group: 'Lunch Squad', cardNumber: '4829', active: true, balance: 45.80, color: '#3B82F6' }, // Blue
    { id: 2, group: 'Roommates', cardNumber: '7234', active: true, balance: 120.00, color: '#A855F7' }, // Purple
    { id: 3, group: 'Road Trip 2026', cardNumber: '5512', active: false, balance: 0, color: '#22C55E' }, // Green
  ]);

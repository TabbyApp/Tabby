...
export function ProcessingPaymentPage({ onNavigate, theme, groupId, accountType, deleteGroup, receiptData }: ProcessingPaymentPageProps) {
  ...
  useEffect(() => {
    ...
    const redirectTimer = setTimeout(() => {
      // For standard accounts, delete group after payment is settled
      // Pro accounts retain the group
      if (accountType === 'standard' && groupId !== null) {
        deleteGroup(groupId);
      }
        ...
        {step === 'processing' ? (
          ...
          >
            ...
            <div className="relative w-32 h-32 mx-auto mb-8">
              <motion.div
                ...
                className="w-32 h-32 border-4 border-blue-200 border-t-blue-500 rounded-full"
              />
            ...
            <h2 className={`text-2xl font-bold ${isDark ? 'text-white' : 'text-slate-800'} mb-3`}>
              Processing Payments
            </h2>
            <p className={`${isDark ? 'text-slate-400' : 'text-slate-600'} mb-8`}>
              Charging cards for each member...
            </p>
          ...
          >
            ...
            <motion.div
              ...
              className="w-32 h-32 rounded-full bg-green-500 flex items-center justify-center mx-auto mb-8 shadow-2xl"
            >
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
            ...
            <motion.h2
              ...
              className={`text-3xl font-bold ${isDark ? 'text-white' : 'text-slate-800'} mb-3`}
            >
              Payment Complete!
            </motion.h2>
            ...
            >
              All charges have been processed successfully
            </motion.p>
            ...
            <motion.div
              ...
              className={`${isDark ? 'bg-slate-800' : 'bg-white'} rounded-2xl p-6 max-w-sm mx-auto shadow-lg`}
            >
